...
#define CUSTOM_MACHINE_NAME "Ender 3 BL Touch BTT SFS"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.5, -7.5, -3.7 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 30//Y_CENTER  // Y point for Z homing
#endif
